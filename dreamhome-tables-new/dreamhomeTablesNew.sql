...
DROP VIEW [Manager View];

CREATE TABLE Branch (
    branchNo VARCHAR(10) PRIMARY KEY NOT NULL,
    street VARCHAR(25),
    city VARCHAR(25),
    postcode VARCHAR (10),
    CHECK(SUBSTR(branchNo,1,1) = 'B')
);

CREATE TABLE Staff (
    staffNo VARCHAR(10) PRIMARY KEY NOT NULL,
    fname VARCHAR(25),
    lname VARCHAR(25),
    position VARCHAR(25),
    sex CHAR(1),
...
CREATE TABLE Client (
    clientNo VARCHAR(10) PRIMARY KEY NOT NULL,
    fname VARCHAR(25),
    lname VARCHAR(25),
    telNo CHAR(11),
    prefType VARCHAR(25),
    maxRent INTEGER,
    email VARCHAR(40),
    CHECK(SUBSTR(clientNo,1,2) = 'CL')

);

CREATE TABLE PrivateOwner (
    ownerNo VARCHAR(10) PRIMARY KEY NOT NULL,
    fname VARCHAR(25),
    lname VARCHAR(25),
    address VARCHAR(40),
    telNo CHAR(11),
